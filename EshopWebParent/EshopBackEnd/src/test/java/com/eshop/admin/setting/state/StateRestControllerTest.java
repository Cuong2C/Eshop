...
public class StateRestControllerTest {
	...
	@Test
	@WithMockUser(username = "beck", password = "password", roles = "Admin")
	...
	@Test
	@WithMockUser(username = "nam", password = "password", roles = "Admin")
	...
	@Test
	@WithMockUser(username = "cuong", password = "password", roles = "Admin")
