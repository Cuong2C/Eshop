...
public class CategoryService {
	...
	private List<Category> listHierarchicalCategories(List<Category> rootCategories, String sortDir){
		...
		for(Category rootCategory : rootCategories) {
			...
			for(Category subCategory: children) {
				...
				hierarchicalCategories.add(Category.fullCopy(subCategory, name));
	...
	public Category get(Integer id) throws UserNotFoundException {
		try {
			...
			throw new UserNotFoundException("Could not find any category by id: "+ id);
		}
	}
	...
	public void updateEnabledCategories(Integer id, Boolean status) {
