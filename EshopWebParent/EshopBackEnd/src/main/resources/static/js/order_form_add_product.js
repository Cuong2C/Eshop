	...
	htmlCode = `
		...
		<input type="hidden" name="detailId" value="0" />
			...
			<div class="row p-2">
				...
				<div class="col-9">
					<img src="${mainImagePath}" class="img-fluid" style="max-height: 150px;"/>
				</div>
				<div class="col-1 col-sm-2 px-2"><i class="fa-solid fa-xmark fa-2x icon-red linkRemove float-right " href="" rowNumber="${nextCount}"></i></div>
			</div>
			...
			<table>
				<tr>
					<td>Product Cost:</td>
					<td>
						<input type="text" required class="form-control m-1 cost-input" name="productDetailCost" rowNumber="${nextCount}" value="${productCost}" style="max-width: 140px"/>
					</td>
				</tr>
				<tr>
					<td>Quantity:</td>
					<td>
						<input type="number" step="1" min="1" max="5" class="form-control m-1 quantity-input" name="quantity" id="${quantityId}" rowNumber="${nextCount}" value="1" style="max-width: 140px"/>
					</td>
				</tr>	
				<tr>
					<td>Unit Price:</td>
					<td>
						<input type="text" required class="form-control m-1 price-input" id="${priceId}" name="productPrice" rowNumber="${nextCount}" value="${productPrice}" style="max-width: 140px"/>
					</td>
				</tr>
				<tr>
					<td>Subtotal:</td>
					<td>
						<input type="text" readonly="readonly" class="form-control m-1 subtotal-output" id="${subtotalId}" name="productSubtotal" value="${productPrice}" style="max-width: 140px"/>
					</td>
				</tr>				
				<tr>
					<td>Shipping Cost:</td>
					<td>
						<input type="text" required class="form-control m-1 ship-input" value="${shippingCost}" name="productShipCost" style="max-width: 140px"/>
					</td>
				</tr>											
			</table>
			</div>
