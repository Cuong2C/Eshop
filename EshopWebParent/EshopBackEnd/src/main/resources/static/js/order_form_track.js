...
function generateTrackCode() {
	...
	htmlCode = `
			<div class="row border rounded p-1 pt-3" id="${rowId}">
	...
	htmlCode += `
				...
				<div class="col-1 col-sm-2 "><i class="fa-solid fa-xmark fa-2x icon-red linkRemoveTrack float-right " href="" rowNumber="${nextCount}"></i></div>			
